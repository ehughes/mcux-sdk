...
- pin_list:
  ...
  - {pin_num: D15, peripheral: GPIO3, signal: 'GPIO, 2', pin_signal: PIO3_2/FC7_P0/CT4_MAT0/PWM0_X0/FLEXIO0_D10/SIM1_PD, direction: OUTPUT, slew_rate: fast, open_drain: disable,
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpio3_pinD15_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO3_2 (pin D15)  */
    GPIO_PinInit(GPIO3, 2U, &gpio3_pinD15_config);
