...
- pin_list:
  - {pin_num: B4, peripheral: WUU0, signal: 'P, 7', pin_signal: PIO1_3/WUU0_IN7/TRIG_OUT1/FC3_P3/CT1_MAT1/SCT0_IN7/FLEXIO0_D11/ENET0_MDIO/SAI1_RXD0/CAN0_RXD/TSI0_CH3/ADC0_A19/CMP0_IN1,
  ...
  - {pin_num: M12, peripheral: SPC0, signal: REQ, pin_signal: PIO5_4/TRIG_OUT7/SPC_LPREQ/TAMPER2/ADC1_B12, open_drain: disable, pull_select: down, pull_enable: disable,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port1_3_pinB4_config = {/* Internal pull-up resistor is enabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_3 (pin B4) is configured as WUU0_IN7 */
    ...
    const port_pin_config_t port5_4_pinM12_config = {/* Internal pull-up/down resistor is disabled */
                                                     kPORT_PullDisable,
                                                     /* Low internal pull resistor value is selected. */
                                                     kPORT_LowPullResistor,
                                                     /* Fast slew rate is configured */
                                                     ...
                                                     /* Low drive strength is configured */
                                                     kPORT_LowDriveStrength,
                                                     /* Pin is configured as SPC_LPREQ */
                                                     kPORT_MuxAlt2,
                                                     /* Digital input enabled */
                                                     kPORT_InputBufferEnable,
                                                     /* Digital input is not inverted */
                                                     ...
                                                     /* Pin Control Register fields [15:0] are not locked */
                                                     kPORT_UnlockRegister};
    /* PORT5_4 (pin M12) is configured as SPC_LPREQ */
    PORT_SetPinConfig(PORT5, 4U, &port5_4_pinM12_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
