...
- ahb:
  - interrupts:
    - security: {Secure: {id: [ADC0_IRQn, ADC1_IRQn, BSP32_IRQn, CAN0_IRQn, CAN1_IRQn, CDOG0_IRQn, CDOG1_IRQn, CMC0_IRQn, CTI0_IRQn, CTIMER0_IRQn, CTIMER1_IRQn,
          ...
          FLEXPWM1_FAULT_IRQn, FLEXPWM1_RELOAD_ERROR_IRQn, FLEXPWM1_SUBMODULE!_IRQn, FLEXPWM1_SUBMODULE0_IRQn, FLEXPWM1_SUBMODULE2_IRQn, FLEXPWM1_SUBMODULE3_IRQn,
          ...
          LP_FLEXCOMM9_IRQn, MAILBOX_IRQn, MRT0_IRQn, NPU_IRQn, OR_IRQn, OS_EVENT_IRQn, PDM_EVENT_IRQn, PINT0_IRQn, PKC_ERR_IRQn, PKC_IRQn, PLU_IRQn, PORT_EFT_IRQn,
          PQ_IRQn, PUF_IRQn, RTC_IRQn, SAI0_IRQn, SAI1_IRQn, SCG_IRQn, SCT0_IRQn, SEC_HYPERVISOR_CALL_IRQn, SEC_VIO_IRQn, SINC_FILTER_IRQn, SM3_IRQn, SMARTDMA_IRQn,
          SPC_IRQn, TRNG0_IRQn, TSI_END_OF_SCAN_IRQn, TSI_OUT_OF_SCAN_IRQn, USB0_DCD_IRQn, USB0_FS_IRQn, USB1_HS_IRQn, USB1_HS_PHY_IRQn, USDHC0_IRQn, UTICK0_IRQn,
          VBAT0_IRQn, WUU_IRQn, WWDT0_IRQn, WWDT1_IRQn]}}
  - ports:
  ...
  - regions: [{memory: PROGRAM_FLASH0, security: s_priv, start: '0x00000000', size: '0x00020000'}, {memory: PROGRAM_FLASH0, security: ns_user, start: '0x00020000',
    ...
    {memory: SRAMB, security: ns_user, start: '0x00000000', size: '0x00008000'}, {memory: SRAMC, security: ns_user, start: '0x00000000', size: '0x00010000'}, {memory: SRAMD,
      ...
      size: '0x00001000'}, {memory: TRO0, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH0, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH1, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH2, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH3, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH4, security: ns_priv, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH5, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH6, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH7, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH8, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH9, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH10, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH11, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH12, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH13, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_0_CH14, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_0_CH15, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH0, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH1, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH2, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH3, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH4, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH5, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH6, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH7, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH8, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH9, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH10, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH11, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH12, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH13, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: eDMA_1_CH14, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: eDMA_1_CH15, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: PKC_RAM, security: ns_user, start: '0x00000000',
      size: '0x00001000'}, {memory: USB_RAM, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: NPU, security: ns_user, start: '0x00000000', size: '0x00001000'},
    {memory: SFA, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: MBC, security: ns_user, start: '0x00000000', size: '0x00001000'}, {memory: CAN0_RULE1,
  ...
  - peripherals: {ns_user: {id: [ADC0, ADC1, BSP32_0, CACHE64_POLSEL0, CAN0, CAN1, CDOG0, CDOG1, CMP0, CMP1, CMP2, CMX_PERFMON0, CMX_PERFMON1, CRC0, CTIMER0, CTIMER1,
        ...
        EWM0, FLEXIO0, FLEXSPI0, FMU0, FMU0TEST, FREQME0, GDET1, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, GPIO5, I3C0, I3C1, INPUTMUX0, INTM0, ITRC0, LPFLEXCOMM0, LPFLEXCOMM1,
        LPFLEXCOMM2, LPFLEXCOMM3, LPFLEXCOMM5, LPFLEXCOMM6, LPFLEXCOMM7, LPFLEXCOMM8, LPFLEXCOMM9, LPTMR0, LPTMR1, MAILBOX, MRT0, NPX0, OPAMP0, OPAMP1, OPAMP2, OTPC0,
        PDM, PINT0, PKC0, PLU0, PORT0, PORT1, PORT2, PORT3, PORT4, PORT5, POWERQUAD, RTC0, SAI0, SAI1, SCG0, SCT0, SEMA42_0, SINC0, SM3_0, SMARTDMA0, SPC0, TDET0,
        TSI0, USBDCD0, USBFS0, USBHS1__USBC, USBPHY, USDHC0, UTICK0, VBAT0, VREF0, WUU0, WWDT0, WWDT1]}, s_priv: {id: [AHBSC, AHBSC_ALIAS1, AHBSC_ALIAS2, AHBSC_ALIAS3,
        GPIO0_ALIAS1, GPIO1_ALIAS1, GPIO2_ALIAS1, GPIO3_ALIAS1, GPIO4_ALIAS1, GPIO5_ALIAS1, LPFLEXCOMM4, PUF, PUF_ALIAS1, PUF_ALIAS2, PUF_ALIAS3, PWM0, PWM1, SYSCON0,
        TRNG0]}}
- sau:
  - enabled: 'true'
...
- user_memory_regions: [{id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x0001FE00'}, {id: Region_2, security: nsc_priv, name: Veneer
      Table, start: '0x1001FE00', size: '0x00000200'}, {id: Region_3, security: s_priv, name: Secure Stack and Data, start: '0x30000000', size: '0x00008000'}, {id: Region_4,
    security: ns_user, name: Non-secure Code, description: Privilege check is disabled so reset value (NS-User) can be used, start: '0x00020000', size: '0x000A0000'},
  {id: Region_5, security: ns_user, name: Non-secure Stack and Data, start: '0x20008000', size: '0x00046000'}]
- mpus:
  - mpu:
    - enabled: 'false'
    - id: 's'
...
void BOARD_InitTrustZone()
{
    ...
    */
    ...
    AHBSC->AIPS_BRIDGE_GROUP1_MEM_RULE0                              = 0x00100003U;
    ...
    AHBSC->AHB_PERIPHERAL1_SLAVE_PORT_P13_SLAVE_RULE0 = 0xCCFFCCFFU;
