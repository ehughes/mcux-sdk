...
#define FLEXIO_SPI_SIN_PIN        28U
#define FLEXIO_SPI_SOUT_PIN       29U
#define FLEXIO_SPI_CLK_PIN        30U
#define FLEXIO_SPI_PCS_PIN        31U
#define SLAVE_FLEXIO_SPI_IRQ      FLEXIO_IRQn
/* Master related */
#define MASTER_LPSPI_BASEADDR         (LPSPI1)
#define MASTER_LPSPI_IRQN             (LP_FLEXCOMM1_IRQn)
#define MASTER_LPSPI_PCS_FOR_INIT     (kLPSPI_Pcs0)
#define MASTER_LPSPI_PCS_FOR_TRANSFER (kLPSPI_MasterPcs0)
#define MASTER_LPSPI_CLOCK_FREQUENCY  CLOCK_GetLPFlexCommClkFreq(1U)
