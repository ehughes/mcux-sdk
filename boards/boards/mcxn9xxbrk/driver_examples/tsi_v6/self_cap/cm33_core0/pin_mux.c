...
- pin_list:
  ...
  - {pin_num: F14, peripheral: GPIO3, signal: 'GPIO, 4', pin_signal: PIO3_4/FC7_P2/CT_INP18/PWM0_X2/FLEXIO0_D12/SIM1_CLK, direction: OUTPUT, eft_interrupt: disable,
  ...
  - {pin_num: D16, peripheral: GPIO3, signal: 'GPIO, 3', pin_signal: PIO3_3/FC7_P1/CT4_MAT1/PWM0_X1/FLEXIO0_D11/SIM1_RST, direction: OUTPUT, eft_interrupt: disable,
    slew_rate: fast, open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, input_buffer: enable, invert_input: normal}
  - {pin_num: A8, peripheral: TSI0, signal: 'CH, 16', pin_signal: PIO0_21/FC0_P5/FC1_P1/CT_INP1/FLEXIO0_D5/I3C0_SCL/TSI0_CH16/ADC0_A13, eft_interrupt: disable, slew_rate: fast,
    open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, passive_filter: disable, input_buffer: disable, invert_input: normal}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    PORT_DisableEFTDetectInterrupts(PORT0, 0x200000u);
    ...
    const port_pin_config_t port0_21_pinA8_config = {/* Internal pull-up/down resistor is disabled */
                                                     ...
                                                     /* Pin is configured as TSI0_CH16 */
                                                     kPORT_MuxAlt0,
    ...
    PORT_DisableEFTDetectInterrupts(PORT3, 0x18u);
