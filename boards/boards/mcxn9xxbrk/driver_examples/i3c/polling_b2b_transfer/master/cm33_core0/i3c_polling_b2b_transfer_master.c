...
#define I3C_TARGET_DYNAMIC_ADDR_7BIT 0x30U
...
int main(void)
{
    ...
    memset(&masterXfer, 0, sizeof(masterXfer));
    g_cmd_txBuff[0]         = I3C_TARGET_DYNAMIC_ADDR_7BIT << 1;
    masterXfer.slaveAddress = I3C_MASTER_SLAVE_ADDR_7BIT;
    masterXfer.data         = g_cmd_txBuff;
    masterXfer.dataSize     = 1;
    masterXfer.direction    = kI3C_Write;
    ...
    memset(&masterXfer, 0, sizeof(masterXfer));
    masterXfer.slaveAddress = I3C_TARGET_DYNAMIC_ADDR_7BIT;
    masterXfer.data         = g_master_txBuff;
    masterXfer.dataSize     = I3C_DATA_LENGTH;
    masterXfer.direction    = kI3C_Write;
    masterXfer.busType      = kI3C_TypeI3CSdr;
