...
2.  Open a serial terminal with the following settings (See Appendix A in Getting started guide for description how to determine serial port number):
    ...
    - One stop bit
    - No flow control
3.  Configure the BOOT_SRC in CFPA @0x01004000 using blhost.
    3.1  Enter ISP mode so that the blhost could program the CFPA.
...
6.  The file bootfromflexspi.bin is used to reset the boot source to internal flash, follow step 3.1,3.2 to program the bootfromflash.bin to 0x01004000
