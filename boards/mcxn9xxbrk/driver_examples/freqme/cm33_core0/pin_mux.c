...
- pin_list:
  ...
  - {pin_num: G4, peripheral: FREQME0, signal: 'IN, 0', pin_signal: PIO1_18/FREQME_CLK_IN0/FC5_P2/FC3_P6/CT3_MAT0/SCT0_IN6/FLEXIO0_D26/PLU_IN4/ENET0_COL/CAN0_TXD/ADC1_A18,
  ...
  - {pin_num: G5, peripheral: FREQME0, signal: 'IN, 1', pin_signal: PIO1_19/WUU0_IN15/FREQME_CLK_IN1/FC5_P3/CT3_MAT1/SCT0_IN7/FLEXIO0_D27/PLU_IN5/ENET0_CRS/CAN0_RXD/ADC1_A19,
    slew_rate: fast, open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, input_buffer: enable, invert_input: normal}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORT1_18 (pin G4) is configured as FREQME_CLK_IN0 */
    ...
    const port_pin_config_t port1_19_pinG5_config = {/* Internal pull-up/down resistor is disabled */
                                                     ...
                                                     /* Pin Control Register fields [15:0] are not locked */
                                                     kPORT_UnlockRegister};
    /* PORT1_19 (pin G5) is configured as FREQME_CLK_IN1 */
