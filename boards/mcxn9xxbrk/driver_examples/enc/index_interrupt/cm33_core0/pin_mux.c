...
- pin_list:
  ...
  - {peripheral: ENC0, signal: INDEX, pin_signal: TRIG_IN0}
  - {peripheral: ENC0, signal: 'PHASE, A', pin_signal: TRIG_IN1}
  - {peripheral: ENC0, signal: 'PHASE, B', pin_signal: TRIG_IN3}
  ...
  - {pin_num: C5, peripheral: INPUTMUX0, signal: 'TRIG_IN, 1', pin_signal: PIO1_1/TRIG_IN1/FC3_P1/FC4_P5/CT_INP5/SCT0_OUT7/FLEXIO0_D9/SAI1_TX_FS/TSI0_CH1/ADC0_A17/CMP1_IN0,
    slew_rate: fast, open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, passive_filter: disable, input_buffer: enable, invert_input: normal}
  - {pin_num: L4, peripheral: INPUTMUX0, signal: 'TRIG_IN, 3', pin_signal: PIO1_22/TRIG_IN3/FC5_P6/FC4_P2/CT_INP14/SCT0_OUT4/FLEXIO0_D30/ADC1_A22, slew_rate: fast,
...
void BOARD_InitPins(void)
{
    ...
    /* TRIG_IN0 is selected as trigger input for ENC0 INDEX channel 0 */
    INPUTMUX_AttachSignal(INPUTMUX0, 0U, kINPUTMUX_TrigIn0ToEnc0Index);
    /* TRIG_IN1 is selected as trigger input for ENC0 PHASEA channel 0 */
    INPUTMUX_AttachSignal(INPUTMUX0, 0U, kINPUTMUX_TrigIn1ToEnc0Phasea);
    /* TRIG_IN3 is selected as trigger input for ENC0 PHASEB channel 0 */
    INPUTMUX_AttachSignal(INPUTMUX0, 0U, kINPUTMUX_TrigIn3ToEnc0Phaseb);
